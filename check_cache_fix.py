# -*- coding: utf-8 -*-
"""
Compare C stream output (after cache layout fix) with Python stream
"""
import numpy as np
import soundfile as sf

# Load outputs
c_stream, _ = sf.read('test_wavs/output_c/stream_cache_fixed.wav')
...
print("=" * 60)
print("Final Comparison (after cache layout fix)")
print("=" * 60)
print(f"\nC Stream vs Python Stream:")
print(f"  Max absolute error: {max_error:.6f}")
print(f"  Mean absolute error: {mean_error:.6f}")
print(f"  RMS C: {c_energy:.6f}")
print(f"  RMS Python: {py_energy:.6f}")
