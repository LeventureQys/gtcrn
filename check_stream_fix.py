# -*- coding: utf-8 -*-
"""
Compare C stream output with Python stream
"""
import numpy as np
import soundfile as sf

# Load outputs
c_stream, _ = sf.read('test_wavs/output_c/stream_fixed_test2.wav')
...
print("=" * 50)
print("C Stream vs Python Stream (after LayerNorm fix)")
print("=" * 50)
